...
// Compile: g++ tutorial01*.cpp -g -I /Users/vincent/Libs/Halide/tools/ -L /usr/local/lib/ -lHalide -o tutorial01 -std=c++11
...
int main(int argc, char** argv)
{
    ...
    Halide::Buffer<int32_t> output = gradient.realize(512, 512);
